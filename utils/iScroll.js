! function (t, i, e) {
  ...
  var n = t.requestAnimationFrame || t.webkitRequestAnimationFrame || t.mozRequestAnimationFrame || t.oRequestAnimationFrame || t.msRequestAnimationFrame || function (i) {
    ...
    o = function () {
      function s(t) {
        return h === !1 ? !1 : "" === h ? t : h + t.charAt(0).toUpperCase() + t.substr(1)
      }
      var n = {},
        o = i.createElement("div").style,
        h = function () {
          for (var t, i = ["t", "webkitT", "MozT", "msT", "OT"], e = 0, s = i.length; s > e; e++)
      ...
      }, n.momentum = function (t, i, s, n, o, h) {
        var r, a, l = t - i,
          c = e.abs(l) / s;
        return h = void 0 === h ? 6e-4 : h, r = t + c * c / (2 * h) * (0 > l ? -1 : 1), a = c / h, n > r ? (r = o ? n - o / 2.5 * (c / 8) : n, l = e.abs(r - t), a = l / c) : r > 0 && (r = o ? o / 2.5 * (c / 8) : 0, l = e.abs(t) + r, a = l / c), {
          destination: e.round(r),
          duration: a
        }
      };
      var r = s("transform");
  ...
  s.prototype = {
    ...
    _move: function (t) {
      if (this.enabled && o.eventType[t.type] === this.initiated) {
        ...
        var i, s, n, h, r = t.touches ? t.touches[0] : t,
          a = r.pageX - this.pointX,
          l = r.pageY - this.pointY,
          c = o.getTime();
        if (this.pointX = r.pageX, this.pointY = r.pageY, this.distX += a, this.distY += l, n = e.abs(this.distX), h = e.abs(this.distY), !(c - this.endTime > 300 && 10 > n && 10 > h)) {
          if (this.directionLocked || this.options.freeScroll || (n > h + this.options.directionLockThreshold ? this.directionLocked = "h" : h >= n + this.options.directionLockThreshold ? this.directionLocked = "v" : this.directionLocked = "n"), "h" == this.directionLocked) {
    ...
    _end: function (t) {
      if (this.enabled && o.eventType[t.type] === this.initiated) {
        ...
        var i, s, n = (t.changedTouches ? t.changedTouches[0] : t, o.getTime() - this.startTime),
          h = e.round(this.x),
          r = e.round(this.y),
          a = e.abs(h - this.startX),
        ...
        if (this.isInTransition = 0, this.initiated = 0, this.endTime = o.getTime(), !this.resetPosition(this.options.bounceTime)) {
          if (this.scrollTo(h, r), !this.moved) return this.options.tap && o.tap(t, this.options.tap), this.options.click && o.click(t), void this._execEvent("scrollCancel");
          if (this._events.flick && 200 > n && 100 > a && 100 > l) return void this._execEvent("flick");
          if (this.options.momentum && 300 > n && (i = this.hasHorizontalScroll ? o.momentum(this.x, this.startX, n, this.maxScrollX, this.options.bounce ? this.wrapperWidth : 0, this.options.deceleration) : {
              destination: h,
              duration: 0
              ...
              destination: r,
              duration: 0
            }, h = i.destination, r = s.destination, c = e.max(i.duration, s.duration), this.isInTransition = 1), this.options.snap) {
            var u = this._nearestSnap(h, r);
            this.currentPage = u, c = this.options.snapSpeed || e.max(e.max(e.min(e.abs(h - u.x), 1e3), e.min(e.abs(r - u.y), 1e3)), 300), h = u.x, r = u.y, this.directionX = 0, this.directionY = 0, p = this.options.bounceEasing
          }
          return h != this.x || r != this.y ? ((h > 0 || h < this.maxScrollX || r > 0 || r < this.maxScrollY) && (p = o.ease.quadratic), void this.scrollTo(h, r, c, p)) : void this._execEvent("scrollEnd")
        }
      }
    },
    _resize: function () {
    ...
    refresh: function () {
      ...
      var t;
      this.options.infiniteElements && (this.options.infiniteLimit = this.options.infiniteLimit || e.floor(2147483645 / this.infiniteElementHeight), t = -this.options.infiniteLimit * this.infiniteElementHeight + this.wrapperHeight), this.maxScrollY = void 0 !== t ? t : this.wrapperHeight - this.scrollerHeight, this.hasHorizontalScroll = this.options.scrollX && this.maxScrollX < 0, this.hasVerticalScroll = this.options.scrollY && this.maxScrollY < 0, this.hasHorizontalScroll || (this.maxScrollX = 0, this.scrollerWidth = this.wrapperWidth), this.hasVerticalScroll || (this.maxScrollY = 0, this.scrollerHeight = this.wrapperHeight), this.endTime = 0, this.directionX = 0, this.directionY = 0, this.wrapperOffset = o.offset(this.wrapper), this._execEvent("refresh"), this.resetPosition()
    },
    on: function (t, i) {
    ...
    scrollTo: function (t, i, e, s) {
      s = s || o.ease.circular, this.isInTransition = this.options.useTransition && e > 0;
    ...
    scrollToElement: function (t, i, s, n, h) {
      if (t = t.nodeType ? t : this.scroller.querySelector(t)) {
        var r = o.offset(t);
        r.left -= this.wrapperOffset.left, r.top -= this.wrapperOffset.top, s === !0 && (s = e.round(t.offsetWidth / 2 - this.wrapper.offsetWidth / 2)), n === !0 && (n = e.round(t.offsetHeight / 2 - this.wrapper.offsetHeight / 2)), r.left -= s || 0, r.top -= n || 0, r.left = r.left > 0 ? 0 : r.left < this.maxScrollX ? this.maxScrollX : r.left, r.top = r.top > 0 ? 0 : r.top < this.maxScrollY ? this.maxScrollY : r.top, i = void 0 === i || null === i || "auto" === i ? e.max(e.abs(this.x - r.left), e.abs(this.y - r.top)) : i, this.scrollTo(r.left, r.top, i, h)
      }
    },
    ...
    _translate: function (t, i) {
      this.options.useTransform ? this.scrollerStyle[o.style.transform] = "translate(" + t + "px," + i + "px)" + this.translateZ : (t = e.round(t), i = e.round(i), this.scrollerStyle.left = t + "px", this.scrollerStyle.top = i + "px"), this.x = t, this.y = i
    },
    ...
    getComputedPosition: function () {
      ...
      return this.options.useTransform ? (s = s[o.style.transform].split(")")[0].split(", "), i = +(s[12] || s[4]), e = +(s[13] || s[5])) : (i = +s.left.replace(/[^-\d.]/g, ""), e = +s.top.replace(/[^-\d.]/g, "")), {
        x: i,
        y: e
      }
    },
    ...
    _wheel: function (t) {
      if (this.enabled) {
        t.preventDefault();
        var i, s, n, o, h = this;
        if (void 0 === this.wheelTimeout && h._execEvent("scrollStart"), clearTimeout(this.wheelTimeout), this.wheelTimeout = setTimeout(function () {
            h.options.snap || h._execEvent("scrollEnd"), h.wheelTimeout = void 0
        ...
        if (i *= this.options.invertWheelDirection, s *= this.options.invertWheelDirection, this.hasVerticalScroll || (i = s, s = 0), this.options.snap) return n = this.currentPage.pageX, o = this.currentPage.pageY, i > 0 ? n-- : 0 > i && n++, s > 0 ? o-- : 0 > s && o++, void this.goToPage(n, o);
        n = this.x + e.round(this.hasHorizontalScroll ? i : 0), o = this.y + e.round(this.hasVerticalScroll ? s : 0), this.directionX = i > 0 ? -1 : 0 > i ? 1 : 0, this.directionY = s > 0 ? -1 : 0 > s ? 1 : 0, n > 0 ? n = 0 : n < this.maxScrollX && (n = this.maxScrollX), o > 0 ? o = 0 : o < this.maxScrollY && (o = this.maxScrollY), this.scrollTo(n, o, 0), this.options.probeType > 1 && this._execEvent("scroll")
      }
    },
    _initSnap: function () {
        ...
        if (this.pages = [], this.wrapperWidth && this.wrapperHeight && this.scrollerWidth && this.scrollerHeight) {
          if (this.options.snap === !0)
            for (s = e.round(c / 2), n = e.round(p / 2); l > -this.scrollerWidth;) {
              ...
              for (h = this.options.snap, t = h.length, i = -1; t > r; r++)(0 === r || h[r].offsetLeft <= h[r - 1].offsetLeft) && (a = 0, i++), this.pages[a] || (this.pages[a] = []), l = e.max(-h[r].offsetLeft, this.maxScrollX), o = e.max(-h[r].offsetTop, this.maxScrollY), s = l - e.round(h[r].offsetWidth / 2), n = o - e.round(h[r].offsetHeight / 2), this.pages[a][i] = {
                x: l,
                y: o,
                width: h[r].offsetWidth,
                height: h[r].offsetHeight,
                cx: s,
                cy: n
              }, l > this.maxScrollX && a++;
    ...
    _nearestSnap: function (t, i) {
      ...
      for (t > 0 ? t = 0 : t < this.maxScrollX && (t = this.maxScrollX), i > 0 ? i = 0 : i < this.maxScrollY && (i = this.maxScrollY); n > s; s++)
        ...
        if (i >= this.pages[0][o].cy) {
          i = this.pages[0][o].y;
          break
        } return s == this.currentPage.pageX && (s += this.directionX, 0 > s ? s = 0 : s >= this.pages.length && (s = this.pages.length - 1), t = this.pages[s][0].x), o == this.currentPage.pageY && (o += this.directionY, 0 > o ? o = 0 : o >= this.pages[0].length && (o = this.pages[0].length - 1), i = this.pages[0][o].y), {
        x: t,
        y: i,
        pageX: s,
        pageY: o
    ...
    goToPage: function (t, i, s, n) {
      ...
      var o = this.pages[t][i].x,
        h = this.pages[t][i].y;
      s = void 0 === s ? this.options.snapSpeed || e.max(e.max(e.min(e.abs(o - this.x), 1e3), e.min(e.abs(h - this.y), 1e3)), 300) : s, this.currentPage = {
        x: o,
        y: h,
        pageX: t,
        pageY: i
      }, this.scrollTo(o, h, s, n)
    },
    next: function (t, i) {
    ...
    prev: function (t, i) {
      var e = this.currentPage.pageX,
        s = this.currentPage.pageY;
      e--, 0 > e && this.hasVerticalScroll && (e = 0, s--), this.goToPage(e, s, t, i)
    },
    ...
    _key: function (t) {
      if (this.enabled) {
        var i, s = this.options.snap,
          ...
          h = s ? this.currentPage.pageY : this.y,
          r = o.getTime(),
          a = this.keyTime || 0,
          l = .25;
        switch (this.options.useTransition && this.isInTransition && (i = this.getComputedPosition(), this._translate(e.round(i.x), e.round(i.y)), this.isInTransition = !1), this.keyAcceleration = 200 > r - a ? e.min(this.keyAcceleration + l, 50) : 0, t.keyCode) {
          case this.options.keyBindings.pageUp:
            this.hasHorizontalScroll && !this.hasVerticalScroll ? n += s ? 1 : this.wrapperWidth : h += s ? 1 : this.wrapperHeight;
            break;
          case this.options.keyBindings.pageDown:
            this.hasHorizontalScroll && !this.hasVerticalScroll ? n -= s ? 1 : this.wrapperWidth : h -= s ? 1 : this.wrapperHeight;
            break;
          case this.options.keyBindings.end:
            n = s ? this.pages.length - 1 : this.maxScrollX, h = s ? this.pages[0].length - 1 : this.maxScrollY;
            break;
          ...
          case this.options.keyBindings.up:
            h += s ? 1 : 5 + this.keyAcceleration >> 0;
            break;
        ...
        if (s) return void this.goToPage(n, h);
        n > 0 ? (n = 0, this.keyAcceleration = 0) : n < this.maxScrollX && (n = this.maxScrollX, this.keyAcceleration = 0), h > 0 ? (h = 0, this.keyAcceleration = 0) : h < this.maxScrollY && (h = this.maxScrollY, this.keyAcceleration = 0), this.scrollTo(n, h, 0), this.keyTime = r
      }
    },
    _animate: function (t, i, e, s) {
      function h() {
        var u, f, d, m = o.getTime();
        return m >= p ? (r.isAnimating = !1, r._translate(t, i), void(r.resetPosition(r.options.bounceTime) || r._execEvent("scrollEnd"))) : (m = (m - c) / e, d = s(m), u = (t - a) * d + a, f = (i - l) * d + l, r._translate(u, f), r.isAnimating && n(h), void(3 == r.options.probeType && r._execEvent("scroll")))
      }
      var r = this,
        a = this.x,
        l = this.y,
    ...
    _initInfinite: function () {
      var t = this.options.infiniteElements;
      this.infiniteElements = "string" == typeof t ? i.querySelectorAll(t) : t, this.infiniteLength = this.infiniteElements.length, this.infiniteMaster = this.infiniteElements[0], this.infiniteElementHeight = this.infiniteMaster.offsetHeight, this.infiniteHeight = this.infiniteLength * this.infiniteElementHeight, this.options.cacheSize = this.options.cacheSize || 1e3, this.infiniteCacheBuffer = e.round(this.options.cacheSize / 4), this.options.dataset.call(this, 0, this.options.cacheSize), this.on("refresh", function () {
        var t = e.ceil(this.wrapperHeight / this.infiniteElementHeight);
        this.infiniteUpperBufferSize = e.floor((this.infiniteLength - t) / 2), this.reorderInfinite()
      }), this.on("scroll", this.reorderInfinite)
    },
    reorderInfinite: function () {
      for (var t = (-this.y + this.wrapperHeight / 2, e.max(e.floor(-this.y / this.infiniteElementHeight) - this.infiniteUpperBufferSize, 0)), i = e.floor(t / this.infiniteLength), s = t - i * this.infiniteLength, n = 0, h = 0, r = [], a = e.floor(t / this.infiniteCacheBuffer); h < this.infiniteLength;) n = h * this.infiniteElementHeight + i * this.infiniteHeight, s > h && (n += this.infiniteElementHeight * this.infiniteLength), this.infiniteElements[h]._top !== n && (this.infiniteElements[h]._phase = n / this.infiniteElementHeight, this.infiniteElements[h]._phase < this.options.infiniteLimit && (this.infiniteElements[h]._top = n, this.options.infiniteUseTransform ? this.infiniteElements[h].style[o.style.transform] = "translate(0, " + n + "px)" + this.translateZ : this.infiniteElements[h].style.top = n + "px", r.push(this.infiniteElements[h]))), h++;
      this.cachePhase != a && (0 === a || t - this.infiniteCacheBuffer > 0) && this.options.dataset.call(this, e.max(a * this.infiniteCacheBuffer - this.infiniteCacheBuffer, 0), this.options.cacheSize), this.cachePhase = a, this.updateContent(r)
    },
    updateContent: function (t) {
      if (void 0 !== this.infiniteCache)
        for (var i = 0, e = t.length; e > i; i++) this.options.dataFiller.call(this, t[i], this.infiniteCache[t[i]._phase])
    },
    updateCache: function (t, i) {
      var e = void 0 === this.infiniteCache;
      this.infiniteCache = {};
      for (var s = 0, n = i.length; n > s; s++) this.infiniteCache[t++] = i[s];
      e && this.updateContent(this.infiniteElements)
    },
